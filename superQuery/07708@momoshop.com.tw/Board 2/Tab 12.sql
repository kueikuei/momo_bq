SELECT 
-- WHERE category = '4' 
-- -- WHERE Order_3m_Never_BeSold_Good != true AND Order_1y_Never_BeSold_Good != true
-- AND IF(Order_1y_Never_BeSold_Good != true,,)
-- CASE
--     -- _1：近3個月銷量為0、近一年銷量為0
--     -- _2：近3個月銷量為0、近一年銷量不為0
--     -- _3：近3個月銷量不為0、近一年銷量為0
--     -- _4：近3個月銷量不為0、近一年銷量不為0
--     WHEN (category = '1' AND Order_3m_Never_BeSold_Good = true AND Order_1y_Never_BeSold_Good = true) THEN '3_1'
--     WHEN (category = '1' AND Order_3m_Never_BeSold_Good = true AND Order_1y_Never_BeSold_Good = false) THEN '3_2'
--     WHEN (category = '1' AND Order_3m_Never_BeSold_Good = false AND Order_1y_Never_BeSold_Good = true) THEN '3_3'
--     WHEN (category = '1' AND Order_3m_Never_BeSold_Good = false AND Order_1y_Never_BeSold_Good = false) THEN '3_4'
--     WHEN (category = '2' AND Order_3m_Never_BeSold_Good = true AND Order_1y_Never_BeSold_Good = true) THEN '3_1'
--     WHEN (category = '2' AND Order_3m_Never_BeSold_Good = true AND Order_1y_Never_BeSold_Good = false) THEN '3_2'
--     WHEN (category = '2' AND Order_3m_Never_BeSold_Good = false AND Order_1y_Never_BeSold_Good = true) THEN '3_3'
--     WHEN (category = '2' AND Order_3m_Never_BeSold_Good = false AND Order_1y_Never_BeSold_Good = false) THEN '3_4'
